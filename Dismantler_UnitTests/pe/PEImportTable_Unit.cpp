...
public:
	TEST_METHOD(Constructor_64bit)
	{
		...
		IMAGE_THUNK_DATA64* firstThunk = reinterpret_cast<IMAGE_THUNK_DATA64*>(pages + import->FirstThunk);
		IMAGE_THUNK_DATA64* originalThunk = reinterpret_cast<IMAGE_THUNK_DATA64*>(pages + import->OriginalFirstThunk);
	...
	TEST_METHOD(Constructor_32bit)
	{
		...
		IMAGE_THUNK_DATA32* firstThunk = reinterpret_cast<IMAGE_THUNK_DATA32*>(pages + import->FirstThunk);
		IMAGE_THUNK_DATA32* originalThunk = reinterpret_cast<IMAGE_THUNK_DATA32*>(pages + import->OriginalFirstThunk);
