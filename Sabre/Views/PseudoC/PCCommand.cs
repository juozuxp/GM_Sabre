...
namespace Sabre.Views.PseudoC
{
	...
	public sealed class PCCommand
	{
		...
		private PCCommand(AsyncPackage package, OleMenuCommandService commandService)
		{
		...
		/// </summary>
		public static PCCommand Instance
		{
			get;
			private set;
		}
		...
		public static async Task InitializeAsync(AsyncPackage package)
		{
			...
			Instance = new PCCommand(package, commandService);
		}
		...
		private void Execute(object sender, EventArgs e)
		{
			...
			{
				ToolWindowPane window = await this.package.ShowToolWindowAsync(typeof(PCView), 0, true, this.package.DisposalToken);
